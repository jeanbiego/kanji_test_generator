...
class TextRenderer:
    ...
    def create_preview(self, problem: Problem) -> str:
        ...
        # 回答漢字をカタカナ読みに置換
        return problem.sentence.replace(problem.answer_kanji, problem.reading)
    ...
    def create_preview_with_blank(self, problem: Problem) -> str:
        ...
        return problem.sentence.replace(problem.answer_kanji, blank)
    ...
    def create_preview_with_underline(self, problem: Problem) -> str:
        ...
        return problem.sentence.replace(problem.answer_kanji, f"{blank}\n{underline}")
