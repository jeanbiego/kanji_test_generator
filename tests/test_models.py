...
class TestProblem:
    ...
    def test_problem_creation(self):
        """問題の作成テスト"""
        problem = Problem(
            sentence="独創的な表現で知られるアーティスト", answer_kanji="独創", reading="どくそう"
        )
    ...
    def test_problem_to_dict(self):
        """辞書形式への変換テスト"""
        problem = Problem(sentence="テスト文", answer_kanji="テスト", reading="てすと")
...
class TestAttempt:
    ...
    def test_attempt_creation(self):
        """試行の作成テスト"""
        attempt = Attempt(problem_id="test-problem-id", is_correct=True)
    ...
    def test_attempt_to_dict(self):
        """辞書形式への変換テスト"""
        attempt = Attempt(problem_id="test-problem-id", is_correct=False)
