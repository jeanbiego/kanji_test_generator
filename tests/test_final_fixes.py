...
from src.app import check_duplicate_problem, show_problem_creation_page
...
class TestFinalFixes:
    ...
    def test_duplicate_warning_display(self):
        ...
        with patch.object(st, "session_state") as mock_session:
            ...
            mock_session.__getitem__ = (
                lambda key: "テスト重複メッセージ" if key == "duplicate_message" else None
            )
